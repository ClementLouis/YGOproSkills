...
function c514000011.aop(e,tp,eg,ev,ep,re,r,rp)
	...
	Duel.SendtoHand(token2,nil,REASON_RULE)
	Duel.SendtoHand(token3,nil,REASON_RULE)
	Duel.SendtoHand(token4,nil,REASON_RULE)
	Duel.SendtoHand(token5,nil,REASON_RULE)
