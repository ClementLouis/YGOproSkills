...
function c514000002.initial_effect(c)
	--active
	...
	e1:SetCountLimit(1)
	e1:SetCondition(c514000002.aco)
	e1:SetOperation(c514000002.aop)
	c:RegisterEffect(e1)
end
function c514000002.aco(e,tp,eg,ev,ep,re,r,rp)
	return Duel.GetTurnCount()==1
end
function c514000002.aop(e,tp,eg,ev,ep,re,r,rp)
